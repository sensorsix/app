          ...
          <div class="row">
            ...
            <div class="col-xs-8 col-sm-5">
              <div class="form-line control-group<?php echo isset($errors[$item->id]) ? ' error' : '' ?>" style="margin: 3px 0 3px 0">
                ...
                <?php endif; ?>
                <input style="width: auto" class="numeric form-control right" type="text" name="measurement[<?php echo $item->id ?>]" value="<?php echo isset($values[$item->id]) ? $values[$item->id] : '' ?>"/>
