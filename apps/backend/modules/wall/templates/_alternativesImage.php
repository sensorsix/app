...
echo stylesheet_tag('/libs/jquery-jqplot/jquery.jqplot.css');
...
<div id="chart-<?php echo $rand; ?>" style="margin-left: 20px; width: 1350px; height: 500px; position: relative;"></div>
...
$(function () {
  ...
  var plot = $.jqplot('chart-<?php echo $rand; ?>', <?php echo $analyze->getJsonData() ?>, {
