...
<div class="modal" id="importModal" tabindex="-1" role="dialog" aria-labelledby="importModalLabel" aria-hidden="true">
  <div class="modal-dialog modal-lg">
    <div class="modal-content" id="importContent">

      <div class="modal-header">
        <button type="button" class="close" data-dismiss="modal"><span aria-hidden="true">×</span><span class="sr-only">Close</span></button>
        <h4 class="modal-title" id="editRowModalLabel">Import</h4>
      </div>
        ...
        <div class="row mr-top-25 import-dashboard">
          ...
          <div class="col-md-4">
            <div class="row">
              ...
              <div class="col-md-12 mr-top-25 text-center import-dashboard-button">
                <a id="add-row-modal" data-toggle="tooltip" title="Create" data-placement="bottom" href="#" onClick="return false;" style="width: 90%;" class="btn btn-success">Create</a>
              </div>
            </div>
          </div>
        </div>
...
<script>
  $(function () {
    ...
    // Import modal
    $('#fileupload-top-modal').on('click', function(e) {
      e.preventDefault();
    ...
    $('#add-row-modal').on('click', function () {
      var $this = $(this);
