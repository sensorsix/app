...
abstract class BasesfGuardUserFormFilter extends BaseFormFilterDoctrine
{
  public function setup()
  {
    $this->setWidgets(array(
      ...
      'last_payment_date' => new sfWidgetFormFilterDate(array('from_date' => new sfWidgetFormDate(), 'to_date' => new sfWidgetFormDate())),
      ...
      'header_color'      => new sfWidgetFormFilterInput(),
      'wizard'            => new sfWidgetFormChoice(array('choices' => array('' => 'yes or no', 1 => 'yes', 0 => 'no'))),
    ...
    $this->setValidators(array(
      ...
      'last_payment_date' => new sfValidatorDateRange(array('required' => false, 'from_date' => new sfValidatorDateTime(array('required' => false, 'datetime_output' => 'Y-m-d 00:00:00')), 'to_date' => new sfValidatorDateTime(array('required' => false, 'datetime_output' => 'Y-m-d 23:59:59')))),
      ...
      'header_color'      => new sfValidatorPass(array('required' => false)),
      'wizard'            => new sfValidatorChoice(array('required' => false, 'choices' => array('', 1, 0))),
  ...
  public function addTypesListColumnQuery(Doctrine_Query $query, $field, $values)
  {
    ...
    $query
      ->leftJoin($query->getRootAlias().'.UserDecisionType UserDecisionType')
      ->andWhereIn('UserDecisionType.type_id', $values)
    ;
  }
